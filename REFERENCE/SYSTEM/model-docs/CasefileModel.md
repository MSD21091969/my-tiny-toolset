...
|-------|------|----------|-------------|
| `id` | str |  | Unique casefile ID in format cf_yymmdd_code |
| `metadata` | CasefileMetadata | ✓ | Casefile metadata |
| `acl` | Optional |  | Access Control List for permissions |
| `resources` | Dict |  | Legacy resource references by type (deprecated) |
| `session_ids` | List |  | Tool session IDs associated with this casefile |
| `notes` | Optional |  | Additional notes |
| `gmail_data` | Optional |  | Typed Gmail data captured for this casefile |
| `drive_data` | Optional |  | Typed Google Drive data captured for this casefile |
| `sheets_data` | Optional |  | Typed Google Sheets data captured for this casefile |
