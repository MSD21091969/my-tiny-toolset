...
| `operation` | Literal |  | - |
| `payload` | CloseChatSessionPayload | ✓ | Request payload |
...
```json
{
  ...
  "description": "Request to close a chat session.",
  "properties": {
    "request_id": {
    ...
    "operation": {
      "const": "close_chat_session",
      "default": "close_chat_session",
      "title": "Operation",
      "type": "string"
    },
    "payload": {
      "$ref": "#/$defs/CloseChatSessionPayload",
