...
| `operation` | Literal |  | - |
| `payload` | CreateCasefilePayload | ✓ | Request payload |
...
```json
{
  ...
  "description": "Request to create a new casefile.",
  "properties": {
    "request_id": {
    ...
    "operation": {
      "const": "create_casefile",
      "default": "create_casefile",
      "title": "Operation",
      "type": "string"
    },
    "payload": {
      "$ref": "#/$defs/CreateCasefilePayload",
