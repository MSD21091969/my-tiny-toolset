...
| `operation` | Literal |  | - |
| `payload` | DeleteCasefilePayload | ✓ | Request payload |
...
```json
{
  ...
  "description": "Request to delete a casefile.",
  "properties": {
    "request_id": {
    ...
    "operation": {
      "const": "delete_casefile",
      "default": "delete_casefile",
      "title": "Operation",
      "type": "string"
    },
    "payload": {
      "$ref": "#/$defs/DeleteCasefilePayload",
