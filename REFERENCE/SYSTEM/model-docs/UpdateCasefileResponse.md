...
| `payload` | CasefileUpdatedPayload | ✓ | Response payload |
...
```json
{
  "$defs": {
    ...
    "CasefileUpdatedPayload": {
      "description": "Response payload for casefile update.",
      "properties": {
        "casefile": {
          "$ref": "#/$defs/CasefileModel",
          "description": "Updated casefile model"
        },
        "updated_fields": {
  ...
  "description": "Response for casefile update.",
  "properties": {
    "request_id": {
    ...
    "payload": {
      "$ref": "#/$defs/CasefileUpdatedPayload",
